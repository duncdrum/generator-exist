...
const gen = require('../../generators/app')

describe('generate empty package', () => {
  ...
  it('runs correctly', () => {
    runResult.assert.noFile(['modules/app.xql', 'templates/page.html', 'test/cypress/integration/login-ok_spec.js', 'index.html'])
  })
